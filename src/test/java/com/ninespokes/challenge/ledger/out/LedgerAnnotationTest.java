...
public class LedgerAnnotationTest {
    ...
    @Setter
    class LedgerAnnotationTest_CurrencyCNY extends LedgerAnnotationTestBase {
    ...
    @Test
    public void test_CurrencyCNY() {
        LedgerAnnotationTest_CurrencyCNY data = new LedgerAnnotationTest_CurrencyCNY();
